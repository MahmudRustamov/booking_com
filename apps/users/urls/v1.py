...
from apps.users.views.owners import OwnersListCreateApiView, OwnersDetailApiView
...
urlpatterns = [
    ...
    path('owners/', OwnersListCreateApiView.as_view(), name="owner-list"),
    path('owners/<int:id>/', OwnersDetailApiView.as_view(), name="owner-detail"),
